...
// - textContent : 공백문자 그대로 반환 IE9 이번 버전에서 사용안됨
// innerText : 공백문자 제거
// div1.innerHTML = "<ul><li>1</li></ul><ul><li>2</li></ul><ul><li>3</li></ul>";
...
// 요소.prepend : 선택된 요소의 맨 첫번쨰 자식으로 추가됨
...
// remove & removeChild
// 요소.remove() : 선택된 요소 삭제
// 요소.removeChild(자식 요소) : 인자 안의 자식요소가 삭제됨
...
// 사진을 추가
// container 마지막 자식으로 img태그 추가
// 이미지 필수 속성 : src alt
let img = document.createElement("img");
container.append(img);
img.setAttribute("src", "/pooh_720.png");
