...
// map, find
// map : 배열내의 모든 원소에 대해 연산한 결과를 모아서 새로울 배열 반환
// [1,2,3].map()
...
let diff = []
// for 문 이용
for(let i=0; i<fruits1.length;1++) {
...
let diff2 = fruits1.filter((fruit)=>!fruits1)
